...
@Component({
  ...
  styles: [
    `
      ...
      .aqi { display: inline-flex; gap: 0.4rem; align-items: baseline; flex-wrap: wrap; }
      .value { font-size: clamp(1.65rem, 5vw, 2rem); font-weight: 700; }
      ...
      dt { margin: 0 0 0.1rem; color: var(--text-muted); font-size: 0.78rem; }
